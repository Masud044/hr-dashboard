...
// src\features\users\module\update-module-page.jsx
...
import { useUpdateModule, useModules } from "./queries";
...
export default function UpdateModulePage() {
  ...
  const { data: rawModules = [], isLoading: isModulesLoading } = useModules();
  const module = rawModules.find((m) => String(m.ID) === String(id));
      ...
      <div className="bg-card rounded-md shadow-sm p-4 mb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-0.5">
            <h1 className="text-lg md:text-2xl font-semibold tracking-tight">Update Module</h1>
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Update Module</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
      ...
      <div className="bg-card rounded-md shadow-sm p-4">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
              <h2 className="text-lg font-semibold">Update Module</h2>
              <p className="text-sm text-muted-foreground">Edit module details for "{module?.MODULE_NAME}"</p>
            </div>
          </div>
