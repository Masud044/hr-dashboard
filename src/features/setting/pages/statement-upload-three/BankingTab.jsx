...
export default function BankingTab({
  ...
  //   selectedCatKeys.length === 4 ? "" : selectedCatKeys.join(",");
  ...
  // const {
  //   data: categoryStats = { address: 0, place: 0, product: 0, other: 0 },
  // } = useQuery({
  //   queryKey: ["statementStagingStats", statsParams],
  //   queryFn: async () => {
  //     const params = new URLSearchParams();
  //     Object.entries(statsParams).forEach(([k, v]) => {
  //       if (v) params.append(k, v);
  //     });
  //     return (
  //       (
  //         await axios.get(
  //           `${url}/api/statement/staging/stats?${params.toString()}`,
  //         )
  //       ).data?.data || { address: 0, place: 0, product: 0, other: 0 }
  //     );
  //   },
  //   refetchOnWindowFocus: false,
  // });
