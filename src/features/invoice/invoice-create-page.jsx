// src\features\invoice\invoice-create-page.jsx
...
import { useContractors, useCreateInvoice, useProjects } from "./queries";
    ...
    <div className="mx-auto w-full max-w-5xl px-4 py-8">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Add a new invoice and optional receipt.</p>
        </div>
      </div>
